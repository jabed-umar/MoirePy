 ...
 * @param {number} radius
 * @param {Float64Array} layer1_vectors
 * @param {Float64Array} _layer2_vectors
 * @param {number} tol
 * @param {number} angle_start
 * @param {number} angle_end
 * @returns {Float64Array}
 */
export function find_values(radius, layer1_vectors, _layer2_vectors, tol, angle_start, angle_end) {
    const ptr0 = passArrayF64ToWasm0(layer1_vectors, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayF64ToWasm0(_layer2_vectors, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.find_values(radius, ptr0, len0, ptr1, len1, tol, angle_start, angle_end);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('avc_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
